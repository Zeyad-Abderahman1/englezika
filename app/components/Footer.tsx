    ...
    <footer className="footer">
      <div className="container footer-grid">
        ...
        <div className="socials" aria-label="روابط التواصل">
          <a href="https://facebook.com/englizeka" aria-label="فيسبوك">
            <Globe2 />
          </a>
          <a href="https://youtube.com/@englizeka" aria-label="يوتيوب">
            <PlaySquare />
          </a>
          <a href="https://instagram.com" aria-label="إنستجرام">
            <Camera />
          </a>
          <a href="https://t.me/englizeka" aria-label="تيليجرام">
            <Send />
          </a>
        </div>
      </div>
